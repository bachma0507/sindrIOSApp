...
-(IBAction)onClickBtn:(id)sender
{
    ...
    {
        UIActionSheet *as=[[UIActionSheet alloc]initWithTitle:@"" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:@"Open Camera",@"Choose from Photo Album", nil];
