...
- (void)viewDidLoad
{
    ...
    slider = [[RangeSlider alloc] initWithFrame:CGRectMake(18, 372, 286, 26)];
    ...
    if (IS_IPHONE_5)
    {
        scrollview.contentSize = CGSizeMake(320, btnSubmitt.frame.origin.y+btnSubmitt.frame.size.height+80);
    }
    else
    {
        scrollview.contentSize = CGSizeMake(320, btnSubmitt.frame.origin.y+btnSubmitt.frame.size.height+70);
    }
...
{
    UIAlertView * alert = [[UIAlertView alloc]initWithTitle:@"Message" message:@"Are you sure you want to logout from your account?" delegate:self cancelButtonTitle:@"No" otherButtonTitles:@"Yes", nil];
    alert.tag =101;
    [alert show];
    /*
    NSMutableDictionary *paramDict = [[NSMutableDictionary alloc] init];
    ...
    if (_response == nil) {
        ...
        if (_response != nil) {
            ...
            if ([[dict objectForKey:@"errFlag"]intValue]==0 && [[dict objectForKey:@"errNum"]intValue]==41)
            {
                ...
                UIAlertView * alert = [[UIAlertView alloc]initWithTitle:@"Message" message:@"Are you sure to want to logout from your account?" delegate:self cancelButtonTitle:@"No" otherButtonTitles:@"Yes", nil];
                alert.tag =101;
                [alert show];
            }
        }
