...
-(void) actionSheet:(UIActionSheet *)actSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    if (actSheet.tag == 200) {
        if(buttonIndex == 0){
            [super sendMailSubject:@"Sindr App!" toRecipents:[NSArray arrayWithObject:@""] withMessage:@"I am using sindr for the iPhone. Why don't you try it out…<br/>Install sindr now!<br/><b>Google Play :-</b> <a href='https://play.google.com/store/apps/details?id=com.barrycjulien.sindr'>https://play.google.com/store/apps/details?id=com.barrycjulien.sindr</a><br/><b>iTunes :-</b>"];
        }
        else if(buttonIndex == 1){
            [super sendMessage:@"I am using sindr for the iPhone! Why don't you try it out…\nInstall Flamer now !\nGoogle Play :- https://play.google.com/store/apps/details?id=com.barrycjulien.sindr\niTunes :-"];
        }
    }
}
